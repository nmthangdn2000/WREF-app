...
public class AllHavestHelperAdapter extends RecyclerView.Adapter<AllHavestHelperAdapter.ViewHodler>{
    ...
    @NonNull
    @Override
    public AllHavestHelperAdapter.ViewHodler onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View view = layoutInflater.inflate(R.layout.item_in_theme_agri, parent,false);
        return new AllHavestHelperAdapter.ViewHodler(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AllHavestHelperAdapter.ViewHodler holder, int position) {
